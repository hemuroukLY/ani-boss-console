...
DEFAULT_REPOSITORY="docker.changqingyun.cn/ani/ani-boss-console"
...
选项：
  ...
  --repository REPOSITORY     镜像仓库，默认 docker.changqingyun.cn/ani/ani-boss-console
  --tag YYYYMMDDHHMM          自定义标签，默认当前时间，如 202609151220
  -h, --help                  显示帮助
